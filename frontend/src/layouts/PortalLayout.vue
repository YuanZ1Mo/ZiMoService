...
function icoOf(m) {
  ...
  if (m.code === 'serverAudioStream') {
    // 服务器音频:声波/喇叭形(线性风格,与其余图标一致)
    return '<path d="M11.5 5.2 7 8.8H3.6v6.4H7l4.5 3.6z"/><path d="M15.4 9.3a4 4 0 0 1 0 5.4"/><path d="M18.3 6.5a8 8 0 0 1 0 11"/>'
  }
